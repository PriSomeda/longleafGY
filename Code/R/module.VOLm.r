...
module.VOLm  <-  function(N=NA, QD=NA, t=NA, d=NA, VOL_OB=NA, VOL_IB=NA){
  ...
  if(is.na(N)==FALSE && is.na(QD)==FALSE && is.na(t)==FALSE &&
     is.na(d)==FALSE && is.na(VOL_OB)==FALSE && is.na(VOL_IB)==FALSE){
  ...
  else if(is.na(N)==FALSE && is.na(QD)==FALSE && is.na(t)==FALSE &&
          is.na(d)==FALSE && is.na(VOL_OB)==FALSE && is.na(VOL_IB)==TRUE){
  ...
  # 3. If only volume inside of bark is provided
          ...
          is.na(d)==FALSE && is.na(VOL_OB)==TRUE && is.na(VOL_IB)==FALSE){
